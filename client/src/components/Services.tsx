...
export function Services() {
  ...
  const normalized = normalizeArrayData<Service>(services, "services");
  const serviceList = normalized.items;
  const servicesValid = normalized.isValid;
  const reason = normalized.reason;
  const hasShapeError = !isLoading && !error && !servicesValid;
